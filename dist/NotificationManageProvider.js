...
const NotificationManageProvider = ({ notificationAvailableKey, children, 
        ...
        (async () => {
            try {
                if (notificationAvailableKey) {
                    console.log("🔑 [NotificationManageProvider] 토큰 초기화 가능 notificationAvailableKey", notificationAvailableKey);
    ...
    (0, react_1.useEffect)(() => {
        (async () => {
            if (token && notificationAvailableKey) {
                console.log("🔑 [NotificationManageProvider] 토큰 리프레시 체크 가능 notificationAvailableKey", notificationAvailableKey);
                try {
